// Color-Grade-Filter: reiner Per-Pixel-Pass im HSV-Raum, portiert aus
// ci_filter.html. Betrifft ausschliesslich Fotos (Hintergrund und Person).
//
// Die sechs Regler sind die Mechanik; WELCHE Werte einen Marken-Look ergeben,
// steht im Marken-Paket (Brand.image.grade). Die Ziel-Farbwinkel der drei
// Pulls sind Teil dieser Mechanik geblieben — sie in die Marke zu heben waere
// der naechste Schritt, sobald eine zweite Marke sie wirklich anders braucht.

import { rgbToHsv, hsvToRgb, hueDiff, normalizeHue } from "./hsv";
