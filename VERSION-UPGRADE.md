...
|---|---|---|---|
| `vite` | ^6.0.0 | ^8.x | Welle 2 — Build-Tool-Major |

## Besonderheit

Vite 6 -> 8 ist der letzte offene Punkt hier. anagram und learnfarsi laufen bereits auf Vite 8 mit demselben React-19-Stack — das Risiko ist damit belegt niedrig. `workbox-window` wurde am 26.08.2026 als direkte devDependency ergaenzt (war vorher nur transitiv ueber `vite-plugin-pwa` da) — nicht wieder entfernen. Achtung: im Working Tree liegt unabhaengige, nicht committete Arbeit an einem Carousel; die nicht mit einbeziehen.
