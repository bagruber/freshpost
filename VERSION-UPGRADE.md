...
|---|---|---|---|
| `typescript` | ^5.7.0 | ~5.9.x | Welle 1 — nur Typen, kein Laufzeitverhalten |
| `vite` | ^6.0.0 | ^8.x | Welle 2 — Build-Tool-Major |

## Besonderheit

`workbox-window` wurde am 26.08.2026 als direkte devDependency ergaenzt (war vorher nur transitiv ueber `vite-plugin-pwa` da). Nicht wieder entfernen.
